...
示例：
  碎片A："某个朋友在某国家留学" (source_date: 2025-06)
  碎片B："某个朋友已回国，在某城市写小说" (source_date: 2026-05)
  → merged_memory: "某个朋友曾在某国家留学，2026年5月已回国，目前在某城市写新小说。"
  → contradiction: null（不标记为矛盾，这是正常的时间线演进）

只有当碎片描述的是**同一时间点但事实冲突**时，才标记为矛盾：
  碎片A："Clara 5月10日去了某城市"
  碎片B："Clara 5月10日待在某城市没出门"
  → 这才是矛盾
