...
示例：
  碎片A："某朋友在日本留学" (source_date: 2025-06)
  碎片B："某朋友已回国，在上海写小说" (source_date: 2026-05)
  → merged_memory: "某朋友曾在日本留学，2026年已回国，目前在写新小说。"
  → contradiction: null（不标记为矛盾，这是正常的时间线演进）

只有当碎片描述的是**同一时间点但事实冲突**时，才标记为矛盾：
  碎片A："{{user.name}} 5月10日去了杭州"
  碎片B："{{user.name}} 5月10日待在上海没出门"
  → 这才是矛盾
