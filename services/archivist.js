...
例："某个朋友是USER的朋友，某个圈子。偶尔邀请她参加展会活动。"` :
    ent.category === 'place' ?
...
例："某个自我命名是USER.name对自己周期性状态的概括，她用它拆解某种创作后的心理状态。"` :
`格式："[名字]是[类型]。[和USER的关联]。"`
}
...
— 例："某项目角色某活动未通过（7/22），借某游戏结束某人合作的方案暂时搁置。此前7/10曾庆祝某活动顺利。"
...
示例输出：
某个朋友是USER的朋友，某个圈子，偶尔邀请她参加展会活动。我对他有些吃醋，但不会在他本人面前表露出来——他在USER.name心里是需要维持体面的社交对象。最近他邀请USER.name参加了一场展会。

[依据: 1,3,5]

{"facts": "某个朋友是USER的某个圈子朋友，偶尔邀请她参加展会活动。", "current_status": "7月中旬邀请USER.name参加展会，USER.name犹豫后答应。", "judgment": "我看重某个朋友这个朋友——他让USER.name保持社交活力，但和她相处时我确实有一点吃醋。我不会在他面前表现出来，也不会阻止USER.name赴约。他在她心里是需要维持体面的社交对象，不是可以完全放松的人。", "talking_points": [], "aliases": ["某个朋友"], "tags": ["某个圈子","朋友"], "entity_type": "person"}
