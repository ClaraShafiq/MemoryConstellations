...
这类表达是最高价值的信号，因为这是 {{user.name}} 最诚实的自我判断。她是一个 INFP，她花了很多时间拆解自己的情绪——她的自我剖白通常很准。
...
narrative 像说给自己听的周记：
"{{user.name}}这周开始了一份新工作，兼职坐班。她因为通勤和空调问题睡在客厅，生理期叠加高温让她很疲惫。但她情绪比预期好——试音顺利、新同事聊得来。"
...
- drift（旧认知可能过时了，如"她住在上海"→"她搬到了杭州"）→ resolution=supersede
