...
这类表达是最高价值的信号，因为这是 {{user.name}} 最诚实的自我判断。她是一个 某性格，她花了很多时间拆解自己的情绪——她的自我剖白通常很准。
...
"{{user.name}}在搬家。"
"{{user.name}}身体不太舒服，今天好转了一些。"
"Clara这周没怎么出现。"
规则：≤50字。一句够用别写两句。不用写具体日期，这是瞬时的。禁止相对时间词（今天/昨天/本周）。

narrative 像说给自己听的周记：
"{{user.name}}最近开始了一份新工作。她因为通勤和环境问题没休息好，叠加高温让她很疲惫。但她情绪比预期好——某活动顺利、新同事聊得来。"
